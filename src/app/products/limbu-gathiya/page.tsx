...
export const metadata: Metadata = {
  title: 'Homemade Limbu Gathiya in Surat | Tikha Gathiya | Shilpa Kitchen',
  description:
    'Order fresh homemade Limbu Gathiya (Tikha Gathiya) from Shilpa Kitchen, Surat. Crunchy gram flour sticks with lemon and spices. Traditional Gujarati recipe. WhatsApp order.',
  keywords: [
    'Limbu Gathiya Surat',
    'Tikha Gathiya Surat',
    'homemade Gathiya',
    'Gujarati Gathiya Surat',
    'order Gathiya online Surat',
    'lemon Gathiya Shilpa Kitchen',
    'traditional Gujarati snacks Surat',
  ],
  openGraph: {
    title: 'Homemade Limbu Gathiya in Surat | Shilpa Kitchen',
    description:
      'Order fresh homemade Limbu Gathiya from Shilpa Kitchen, Surat. Crunchy gram flour sticks with lemon and Gujarati spices.',
    url: 'https://www.shilpaskitchen.in/products/limbu-gathiya',
    images: [
      {
        url: '/images/gathiya.png',
        width: 1200,
        height: 630,
        alt: 'Homemade Limbu Gathiya in Surat - Shilpa Kitchen',
      },
    ],
  },
  twitter: {
    ...
    title: 'Homemade Limbu Gathiya in Surat | Shilpa Kitchen',
    description: 'Order fresh homemade Limbu Gathiya from Shilpa Kitchen, Surat.',
    images: ['/images/gathiya.png'],
  },
  alternates: {
    canonical: '/products/limbu-gathiya',
  },
};
...
const productSchema = {
  ...
  '@type': 'Product',
  name: 'Homemade Limbu Gathiya in Surat',
  image: 'https://www.shilpaskitchen.in/images/gathiya.png',
  description:
    'Crunchy homemade Limbu Gathiya made with gram flour, lemon, and traditional Gujarati spices. Fresh and crispy, made daily in Surat.',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'What is Limbu Gathiya?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Limbu Gathiya is a popular Gujarati snack made from gram flour (besan) extruded into thin sticks and fried until crispy. It is flavored with lemon, green chili, and traditional spices — known for its tangy and spicy taste.',
      },
    },
    {
      '@type': 'Question',
      name: 'How long does homemade Gathiya stay fresh?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Homemade Gathiya stays fresh for up to 15–20 days when stored in an airtight container at room temperature away from moisture.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Is Gathiya suitable for vegetarians?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes, our Limbu Gathiya is 100% vegetarian. It is made only from gram flour, lemon, and spices — no animal products whatsoever.',
      },
    },
  ],
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Limbu Gathiya', item: 'https://www.shilpaskitchen.in/products/limbu-gathiya' },
  ],
};

export default function LimbuGathiyaPage() {
  const faqs = faqSchema.mainEntity;
  const waUrl = buildWhatsAppUrl('Limbu Gathiya');
        ...
        <nav aria-label="Breadcrumb" className="bg-[#0E0E0E] border-b border-[#C6A75E]/20">
          <div className="container mx-auto px-6 py-3">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li className="text-[#F5F3EF]/50" aria-hidden="true">/</li>
              <li className="text-[#F5F3EF]" aria-current="page">Limbu Gathiya</li>
            </ol>
          </div>
        </nav>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-[#C6A75E] text-lg font-medium mb-4">
                  Tikha Gathiya · Traditional Gujarati Snack · Surat
                </p>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-[#F5F3EF]/70 text-sm">4.8 · 134 reviews</span>
                </div>
                <p className="text-lg text-[#F5F3EF]/80 leading-relaxed">
                  Our Limbu Gathiya brings together the classic crunch of gram flour sticks with the
                  tangy freshness of lemon and bold Gujarati spices. A beloved snack in every Surat
                  household — perfect with evening tea or as an anytime munch.
                </p>
              </div>

              <div className="flex items-baseline space-x-2">
                <span className="text-3xl font-bold text-[#C6A75E]">₹100</span>
              ...
              <a
                ...
                aria-label="Order Limbu Gathiya via WhatsApp"
              >
                <WhatsAppIcon />
          ...
          <div className="mt-16 grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <section aria-labelledby="desc-heading" className="bg-[#1a1a1a] rounded-2xl p-8 border border-[#C6A75E]/20">
                <h2 id="desc-heading" className="text-2xl font-bold text-[#F5F3EF] mb-6">About Limbu Gathiya</h2>
                <div className="space-y-4 text-[#F5F3EF]/80 leading-relaxed">
                  <p>
                    Gathiya is one of Gujarat&apos;s most iconic namkeen snacks. Our Limbu (lemon) Gathiya is made
                    from high-quality gram flour (besan), freshly squeezed lemon juice, and a carefully
                    balanced blend of spices for that characteristic tangy-spicy punch.
                  </p>
                  <p>
                    Each batch is hand-crafted in our Surat kitchen using traditional methods — no artificial
                    colors or preservatives. The result is a perfectly crispy, light, and addictive snack
                    that pairs beautifully with masala chai or as a standalone munch.
                  </p>
                </div>
              </section>
